...
@click.group()
@click.version_option(version="1.0.0", prog_name="OpenAccelerator")
@click.option("--debug", is_flag=True, help="Enable debug mode")
@click.option("--config", type=click.Path(), help="Configuration file path")
@click.pass_context
def cli(ctx, debug, config):
    """
    [SYSTEM] OpenAccelerator - Advanced ML Accelerator Simulator
