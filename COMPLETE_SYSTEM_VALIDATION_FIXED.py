...
def test_imports():
    ...
    try:
        ...
        from open_accelerator.workloads.medical import MedicalWorkloadConfig, MedicalConvolution
...
def test_workload_creation():
    ...
    try:
        ...
        print(f"[INFO] Matrix dimensions: {workload.M}x{workload.K} * {workload.K}x{workload.P}")
        print(f"[INFO] Expected operations: {workload.get_complexity()['total_operations']}")
