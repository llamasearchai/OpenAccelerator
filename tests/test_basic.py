...
try:
    ...
    from open_accelerator.workloads.base import BaseWorkload, ComputeWorkload, MLWorkload
    ...
    from open_accelerator.core.power import SystemPowerManager, PowerConfig
...
class TestSystolicArray:
    ...
    def test_systolic_array_cycle_execution(self):
        ...
        input_data = {
            'edge_a': np.array([1.0, 2.0]),
            'edge_b': np.array([3.0, 4.0])
        }
...
class TestPowerManagement:
    ...
    def test_power_component_registration(self):
        ...
        # Register component
        component_manager = power_manager.register_component("test_component", power_model)
...
class TestIntegration:
    ...
    def test_config_consistency(self):
        ...
        if config.medical.enable_medical_mode:
            assert config.medical.phi_compliance is True or config.medical.phi_compliance is False
