...
class APISecurityTester:
    ...
    def _test_simulation_access(self):
        ...
        try:
            ...
            test_result = {
                ...
                "expected": 200,
                "actual": response.status_code,
                "passed": response.status_code in [200, 404],  # 404 is ok if simulation doesn't exist
                "details": response.json() if response.status_code not in [200, 404] else None
            }
    ...
    def _test_agent_access(self):
        ...
        try:
            ...
            test_result = {
                ...
                "expected": 200,
                "actual": response.status_code,
                "passed": response.status_code in [200, 422],  # 422 is ok for invalid payload
                "details": response.json() if response.status_code not in [200, 422] else None
            }
    ...
    def _test_simulation_validation(self):
        ...
        invalid_payloads = [
            ...
            # Invalid data types
            {
                "accelerator_config": "invalid_config",
                "workload": 123
            },
        ...
        for i, payload in enumerate(invalid_payloads):
            try:
                ...
                test_result = {
                    ...
                    "payload": payload,
                    "details": response.json() if response.status_code not in [400, 422] else None
                }
            ...
            try:
                ...
                for header in required_headers:
                    test_result = {
                        ...
                        "expected": "Present",
                        "actual": "Present" if header in response.headers else "Missing",
        ...
        for payload in payloads:
            try:
                ...
                test_result = {
                    ...
                    "payload": payload,
                    "details": response.json() if response.status_code not in [400, 422, 500] else None
                }
    ...
    def _generate_summary(self):
        ...
        logger.info(f"Security tests completed: {passed_tests}/{total_tests} passed ({self.results['summary']['overall']['pass_rate']:.1f}%)")
...
def main():
    ...
    parser.add_argument("--output-file", default="api_security_report.json", help="Output file for results")
