...
class WorkloadRequirements:
    ...
    memory_requirements: Dict[str, float] = field(
        default_factory=lambda: {"input": 1.0, "weight": 1.0, "output": 1.0}
    )
...
class MedicalWorkload(MLWorkload):
    ...
    def __init__(self, name: str = "MedicalWorkload"):
        ...
        self.requirements.supported_data_types = [
            "float32"
        ]  # Medical requires high precision
