...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        try:
            from ..ai.agents import AgentConfig, AgentOrchestrator
    ...
    openapi_schema["components"]["examples"] = {
        "BasicSimulation": {
            ...
            "value": {
                ...
                "accelerator_config": {
                    "name": "test_config",
                    "array": {"rows": 4, "cols": 4, "dataflow": "output_stationary"},
                    "memory": {
                        "l1_cache_size": 32768,
                ...
                "workload": {"type": "gemm", "config": {"m": 16, "k": 16, "p": 16}},
        ...
        "MedicalWorkflow": {
            ...
            "value": {
                ...
                "study_id": "STUDY_456",
                "metadata": {"modality": "CT", "body_part": "liver", "contrast": True},
